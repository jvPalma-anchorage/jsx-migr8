/**
 * High-level backup snapshot operations
 * Provides simplified interfaces for creating and restoring backups
 */
import { getBackupManager } from "../backup-manager";
import { BackupId, BackupMetadata, BackupIntegrityResult } from "../types";
